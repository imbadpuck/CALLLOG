app.controller('ManageUserController', ['$scope', '$state', 'user_list','$uibModal','$http','Auth','$rootScope','toastr','$uibModalStack',
  function ($scope, $state, user_list,$uibModal,$http,Auth,$rootScope,toastr,$uibModalStack) {
